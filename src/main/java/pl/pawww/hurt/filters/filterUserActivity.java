...
public class filterUserActivity implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("filterUserActivity:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("filterUserActivity:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        debugActiv = filterConfig.getInitParameter("debug");
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("filterUserActivity()");
        }
        StringBuffer sb = new StringBuffer("filterUserActivity(");
